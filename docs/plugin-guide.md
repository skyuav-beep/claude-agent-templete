...
- L3 Hooks: `.claude/hooks/` (승인·파괴 명령·비밀 파일·STATE 가드레일과 알림 훅) + `settings.template.json` -> 설치 대상의 `settings.local.json`
...
- Codex Layer: `.codex/` (workflow 11종 + checks 2종 + subagent prompt guide 6종)
